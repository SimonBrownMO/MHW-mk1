...
termGAM      <- fn_fitJointTermGAM(events01, fmla1N, stdiag=st.diag.term)
...
# termGLM      <- fn_fitJointTermGLM(events01, fmla1N, stdiag=st.diag.term)

# save
save(file=HDconfig$term$st_Term, termGAM)
